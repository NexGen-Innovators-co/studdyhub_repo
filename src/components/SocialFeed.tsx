...
export const SocialFeed: React.FC<SocialFeedProps> = ({ userProfile }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen">
      {/* Main container for the social feed */}

      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as 'feed' | 'trending' | 'groups' | 'profile')} className="w-full">
