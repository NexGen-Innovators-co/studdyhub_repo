          ...
          {filteredAndSortedDocuments.length === 0 ? (
            ...
            <div className={viewMode === 'grid' 
              ...
              {filteredAndSortedDocuments.map((doc) => (
                <Card 
                  key={doc.id} 
                  className={`group border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm hover:scale-[1.02] overflow-hidden ${
                    viewMode === 'list' ? 'flex' : ''
                  }`}
                >
                  <CardContent className="p-0">
