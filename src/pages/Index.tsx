...
const Index = () => {
  ...
  const tabContentProps = useMemo(() => ({
    ...
    onCreateNoteWithData: handleCreateNoteWithData,
  ...
  // No user: if auth is still loading show spinner, otherwise return null
  // (the useEffect above already triggers navigate('/auth'))
  if (!user) {
