...
import {
  Trophy, Crown, Zap, ArrowRight, Target,
  Maximize2, Minimize2, LogOut, Play, Share2
} from 'lucide-react';
import { LiveQuizSession, LiveQuizPlayer } from '@/modules/quizzes/services/liveQuizService';
