...
import { speakText as cloudSpeakText } from '../../../services/cloudTtsService';
...
// Removed stray comment
  ...
  const processMarkdownForSpeech = (markdownContent: string): string => {
    ...
    // Remove HTML tags (notes may contain raw HTML)
    processedText = processedText.replace(/<\/?[a-z][a-z0-9]*\b[^>]*>/gi, '');
    ...
    // Remove emojis that can cause TTS API issues
    processedText = processedText.replace(/[\u{1F600}-\u{1F64F}\u{1F300}-\u{1F5FF}\u{1F680}-\u{1F6FF}\u{1F700}-\u{1F77F}\u{1F780}-\u{1F7FF}\u{1F800}-\u{1F8FF}\u{1F900}-\u{1F9FF}\u{1FA00}-\u{1FA6F}\u{1FA70}-\u{1FAFF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}\u{2B50}\u{2B55}\u{2934}\u{2935}\u{2B05}\u{2B06}\u{27A1}\u{1F1E6}-\u{1F1FF}]/gu, '');

    // Remove angle brackets that could be misinterpreted as SSML
