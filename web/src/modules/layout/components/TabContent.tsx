...
import { ClassRecordings } from '../../classRecordings/components/ClassRecordings';
...
import { SocialFeed, SocialFeedHandle } from '../../social/components/SocialFeed';
import { Quizzes } from '../../quizzes/components/Quizzes';
...
import { CourseLibrary } from '../../courseLibrary/components/CourseLibrary';
...
const PodcastsPage = React.lazy(() => import('../../podcasts/components/PodcastsPage').then(module => ({ default: module.PodcastsPage })));
