// src/components/quizzes/components/IndividualLeaderboard.tsx
import React from 'react';
import { Trophy, Crown, Zap, CheckCircle } from 'lucide-react';
import { LiveQuizPlayer, LiveQuizQuestion } from '@/modules/quizzes/services/liveQuizService';
...
export const IndividualLeaderboard: React.FC<LiveQuizLeaderboardProps> = ({
  players,
  currentQuestion,
  userId,
}) => {
