...
const INTENT_TABLE_MAP: Record<string, string[]> = {
  ...
  streak: ['user_stats'],
  xp: ['user_stats'],
  // Composite intents — map to the tables relevant to high-level actions
  content_creation: ['notes', 'flashcards', 'quizzes', 'documents', 'ai_podcasts'],
  content: ['notes', 'documents', 'flashcards', 'quizzes', 'ai_podcasts'],
  creation: ['notes', 'flashcards', 'quizzes', 'documents', 'ai_podcasts'],
  create: ['notes', 'flashcards', 'quizzes', 'documents', 'ai_podcasts', 'schedule_items', 'user_learning_goals'],
  generate: ['notes', 'flashcards', 'quizzes', 'ai_podcasts'],
  make: ['notes', 'flashcards', 'quizzes', 'documents'],
  study: ['notes', 'flashcards', 'quizzes', 'user_learning_goals'],
  review: ['notes', 'flashcards', 'quizzes'],
  research: ['notes', 'documents'],
  ethics: ['notes', 'documents'],
  summary: ['notes', 'documents'],
  summarize: ['notes', 'documents'],
  prepare: ['notes', 'flashcards', 'quizzes', 'schedule_items'],
  practice: ['flashcards', 'quizzes'],
  test: ['quizzes', 'quiz_attempts'],
  exam: ['quizzes', 'quiz_attempts', 'schedule_items'],
  assignment: ['notes', 'documents', 'schedule_items'],
  timetable: ['schedule_items', 'courses', 'course_enrollments'],
  import: ['documents', 'document_folders'],
  export: ['notes', 'documents', 'flashcards'],
  share: ['social_posts', 'social_groups'],
  friend: ['social_users', 'social_groups'],
  referral: ['user_stats'],
  achievement: ['achievements', 'badges'],
  level: ['user_stats'],
  xp: ['user_stats', 'achievements'],
  balance: ['user_stats'],
  points: ['user_stats'],
  leaderboard: ['user_stats', 'profiles'],
  rank: ['user_stats', 'profiles'],
  competition: ['user_stats'],
  score: ['quiz_attempts', 'user_stats'],
  grade: ['quiz_attempts', 'user_stats'],
  progress: ['user_stats', 'user_learning_goals'],
  habit: ['user_stats'],
  streak: ['user_stats'],
  daily: ['user_stats', 'schedule_items'],
  weekly: ['user_stats', 'schedule_items'],
  today: ['schedule_items', 'user_stats'],
  tomorrow: ['schedule_items'],
  this_week: ['schedule_items'],
  assignment: ['schedule_items', 'notes', 'documents'],
  class: ['schedule_items', 'courses', 'course_enrollments'],
  lecture: ['schedule_items', 'notes', 'class_recordings'],
  video: ['documents', 'notes'],
  youtube: ['documents', 'notes'],
  website: ['documents', 'web_resource'],
  image: ['documents'],
  file: ['documents', 'document_folders'],
  folder: ['document_folders'],
  search: ['notes', 'documents', 'flashcards', 'quizzes'],
  find: ['notes', 'documents', 'flashcards', 'quizzes'],
  show: ['notes', 'documents', 'flashcards', 'quizzes', 'schedule_items'],
  list: ['notes', 'documents', 'flashcards', 'quizzes', 'schedule_items'],
  delete: ['notes', 'documents', 'flashcards', 'quizzes', 'schedule_items'],
  update: ['notes', 'documents', 'flashcards', 'quizzes', 'schedule_items'],
  edit: ['notes', 'documents', 'flashcards', 'quizzes'],
  save: ['notes', 'documents', 'flashcards', 'quizzes', 'schedule_items'],
  add: ['notes', 'documents', 'flashcards', 'quizzes', 'schedule_items'],
  remove: ['notes', 'documents', 'flashcards', 'quizzes'],
  enroll: ['courses', 'course_enrollments'],
  course: ['courses', 'course_enrollments'],
  subject: ['courses', 'course_enrollments'],
  teacher: ['profiles'],
  tutor: ['profiles'],
  ai: ['chat_sessions', 'chat_messages', 'ai_user_memory'],
  ollie: ['chat_sessions', 'chat_messages', 'ai_user_memory'],
  help: ['chat_sessions', 'chat_messages'],
  explain: ['notes', 'documents'],
  understand: ['notes', 'documents'],
  learn: ['notes', 'flashcards', 'quizzes', 'user_learning_goals'],
  teach: ['notes', 'documents', 'flashcards'],
  remember: ['ai_user_memory'],
  forget: ['ai_user_memory'],
  interest: ['ai_user_memory'],
  preference: ['ai_user_memory'],
  habit: ['ai_user_memory', 'user_stats'],
  style: ['ai_user_memory', 'profiles'],
  level: ['profiles', 'user_stats'],
  tier: ['profiles'],
  grade: ['profiles', 'user_stats'],
  school: ['profiles'],
  university: ['profiles'],
  college: ['profiles'],
  primary: ['profiles'],
