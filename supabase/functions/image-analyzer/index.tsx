...
serve(async (req) => {
    ...
    try {
        ...
        (`Fetching image from URL: ${fileUrl} for document ID: ${documentId}`);
        ...
        ("Image fetched and converted to Base64 on server.");
        const imagePart = {
            inlineData: {
...
Do NOT interpret the meaning, provide educational context, highlight key concepts, or generate study notes. Your output should be a factual description of the image's raw content.`;
        ...
        (`Document ${documentId} updated with image description.`);
        return new Response(JSON.stringify({
            status: 'success',
            document: data,
