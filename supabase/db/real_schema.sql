...
CREATE TABLE public.quizzes (
  ...
  created_at timestamp with time zone DEFAULT now(),
  source_type text DEFAULT 'recording'::text CHECK (source_type = ANY (ARRAY['recording'::text, 'notes'::text, 'ai'::text, 'live_custom'::text, 'manual'::text, 'generated'::text, 'imported'::text, 'cram_sheet'::text, 'ai_generated'::text])),
...
CREATE TABLE public.user_stats (
  ...
  badges_earned ARRAY NOT NULL DEFAULT '{}'::text[],
